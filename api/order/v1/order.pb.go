...
type OrderInfoDetailReponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OrderInfo     *OrderInfoResponse     `protobuf:"bytes,1,opt,name=orderInfo,proto3" json:"orderInfo,omitempty"`
	Goods         []*OrderItemReponse    `protobuf:"bytes,2,rep,name=goods,proto3" json:"goods,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OrderInfoDetailReponse) Reset() {
	*x = OrderInfoDetailReponse{}
	mi := &file_order_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OrderInfoDetailReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderInfoDetailReponse) ProtoMessage() {}

func (x *OrderInfoDetailReponse) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrderInfoDetailReponse.ProtoReflect.Descriptor instead.
func (*OrderInfoDetailReponse) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{1}
}

func (x *OrderInfoDetailReponse) GetOrderInfo() *OrderInfoResponse {
	if x != nil {
		return x.OrderInfo
	}
	return nil
...
func (x *OrderInfoDetailReponse) GetGoods() []*OrderItemReponse {
	if x != nil {
		return x.Goods
	}
	return nil
...
func (x *OrderItemReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderItemReponse) ProtoMessage() {}

func (x *OrderItemReponse) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrderItemReponse.ProtoReflect.Descriptor instead.
func (*OrderItemReponse) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{2}
}

func (x *OrderItemReponse) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *OrderItemReponse) GetOrderId() int32 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *OrderItemReponse) GetGoodsId() int32 {
	if x != nil {
		return x.GoodsId
	}
	return 0
...
func (x *OrderItemReponse) GetGoodsName() string {
	if x != nil {
		return x.GoodsName
	}
	return ""
...
func (x *OrderItemReponse) GetGoodsImage() string {
	if x != nil {
		return x.GoodsImage
	}
	return ""
...
func (x *OrderItemReponse) GetGoodsPrice() float32 {
	if x != nil {
		return x.GoodsPrice
	}
	return 0
...
func (x *OrderItemReponse) GetNums() int32 {
	if x != nil {
		return x.Nums
	}
	return 0
...
type OrderRequest struct {
	...
	Mobile        string                 `protobuf:"bytes,5,opt,name=mobile,proto3" json:"mobile,omitempty"`   // 收货手机号码
	...
	OrderItems    []*OrderItemReponse    `protobuf:"bytes,8,rep,name=orderItems,proto3" json:"orderItems,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OrderRequest) GetOrderItems() []*OrderItemReponse {
	if x != nil {
		return x.OrderItems
	}
	return nil
...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x1a\x1bgoogle/protobuf/empty.proto\"O\n" +
	"\vOrderStatus\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x18\n" +
	"\aorderSn\x18\x02 \x01(\tR\aorderSn\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\"s\n" +
	"\x16OrderInfoDetailReponse\x120\n" +
	"\torderInfo\x18\x01 \x01(\v2\x12.OrderInfoResponseR\torderInfo\x12'\n" +
	"\x05goods\x18\x02 \x03(\v2\x11.OrderItemReponseR\x05goods\"\xc8\x01\n" +
	"\x10OrderItemReponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x18\n" +
	...
	"goodsPrice\x12\x12\n" +
	"\x04nums\x18\a \x01(\x05R\x04nums\"d\n" +
	...
	"\x04data\x18\x02 \x03(\v2\x12.OrderInfoResponseR\x04data\"\xdd\x01\n" +
	...
	"\aorderSn\x18\a \x01(\tR\aorderSn\x121\n" +
	"\n" +
	"orderItems\x18\b \x03(\v2\x11.OrderItemReponseR\n" +
	"orderItems\"\x91\x02\n" +
	...
	"\aaddTime\x18\v \x01(\tR\aaddTime\"\xdf\x01\n" +
	...
	"\achecked\x18\b \x01(\bR\achecked\"\x1a\n" +
	"\bUserInfo\x12\x0e\n" +
	...
	"\x05total\x18\x01 \x01(\x05R\x05total\x12)\n" +
	"\x04data\x18\x02 \x03(\v2\x15.ShopCartInfoResponseR\x04data2\xb9\x04\n" +
	"\x05Order\x120\n" +
	...
	"\tOrderList\x12\x13.OrderFilterRequest\x1a\x12.OrderListResponse\x125\n" +
	"\vOrderDetail\x12\r.OrderRequest\x1a\x17.OrderInfoDetailReponse\x129\n" +
...
var file_order_proto_goTypes = []any{
	...
	(*OrderInfoDetailReponse)(nil), // 1: OrderInfoDetailReponse
	(*OrderItemReponse)(nil),       // 2: OrderItemReponse
...
var file_order_proto_depIdxs = []int32{
	6,  // 0: OrderInfoDetailReponse.orderInfo:type_name -> OrderInfoResponse
	2,  // 1: OrderInfoDetailReponse.goods:type_name -> OrderItemReponse
	6,  // 2: OrderListResponse.data:type_name -> OrderInfoResponse
	2,  // 3: OrderRequest.orderItems:type_name -> OrderItemReponse
	9,  // 4: CartItemListResponse.data:type_name -> ShopCartInfoResponse
	8,  // 5: Order.CartItemList:input_type -> UserInfo
	7,  // 6: Order.CreateCartItem:input_type -> CartItemRequest
	7,  // 7: Order.UpdateCartItem:input_type -> CartItemRequest
	7,  // 8: Order.DeleteCartItem:input_type -> CartItemRequest
	5,  // 9: Order.CreateOrder:input_type -> OrderRequest
	5,  // 10: Order.CreateOrderCom:input_type -> OrderRequest
	5,  // 11: Order.SubmitOrder:input_type -> OrderRequest
	3,  // 12: Order.OrderList:input_type -> OrderFilterRequest
	5,  // 13: Order.OrderDetail:input_type -> OrderRequest
	0,  // 14: Order.UpdateOrderStatus:input_type -> OrderStatus
	10, // 15: Order.CartItemList:output_type -> CartItemListResponse
	9,  // 16: Order.CreateCartItem:output_type -> ShopCartInfoResponse
	...
	4,  // 22: Order.OrderList:output_type -> OrderListResponse
	1,  // 23: Order.OrderDetail:output_type -> OrderInfoDetailReponse
