...
type OrderClient interface {
	...
	OrderDetail(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderInfoDetailReponse, error)
...
func (c *orderClient) OrderDetail(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderInfoDetailReponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderInfoDetailReponse)
...
type OrderServer interface {
	...
	OrderDetail(context.Context, *OrderRequest) (*OrderInfoDetailReponse, error)
...
func (UnimplementedOrderServer) OrderDetail(context.Context, *OrderRequest) (*OrderInfoDetailReponse, error) {
