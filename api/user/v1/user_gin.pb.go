...
func (s *UserHttpServer) RegisterService() {
	...
	s.router.Handle("GET", "/v1/users", s.GetUserList_0)

	s.router.Handle("GET", "/v1/user/mobile", s.GetUserByMobile_0)

	s.router.Handle("GET", "/v1/user/id", s.GetUserById_0)

	s.router.Handle("POST", "/v1/user/create", s.CreateUser_0)

	s.router.Handle("PUT", "/v1/user/update", s.UpdateUser_0)

	s.router.Handle("GET", "/v1/user/password", s.CheckPassword_0)
