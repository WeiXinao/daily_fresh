...
type SayHelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // @gotags: binding:"required" uri:"name"
...
const file_hello_proto_rawDesc = "" +
	...
	"\x05greet\x18\x01 \x01(\tR\x05greet2\x90\x01\n" +
	"\fHelloService\x12Q\n" +
	"\bSayHello\x12\x10.SayHelloRequest\x1a\x11.SayHelloResponse\" \x82\xd3\xe4\x93\x02\x1a:\x01*\x12\x15/user/sayHello/{name}\x12-\n" +
	"\x06SayBye\x12\x10.SayHelloRequest\x1a\x11.SayHelloResponseB\n" +
...
var file_hello_proto_depIdxs = []int32{
	...
	0, // 1: HelloService.SayBye:input_type -> SayHelloRequest
	1, // 2: HelloService.SayHello:output_type -> SayHelloResponse
	1, // 3: HelloService.SayBye:output_type -> SayHelloResponse
