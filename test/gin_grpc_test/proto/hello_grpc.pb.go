...
const (
	...
	HelloService_SayBye_FullMethodName   = "/HelloService/SayBye"
)
...
type HelloServiceClient interface {
	...
	SayBye(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error)
}
...
func (c *helloServiceClient) SayBye(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SayHelloResponse)
	err := c.cc.Invoke(ctx, HelloService_SayBye_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServiceServer interface {
	...
	SayBye(context.Context, *SayHelloRequest) (*SayHelloResponse, error)
...
func (UnimplementedHelloServiceServer) SayBye(context.Context, *SayHelloRequest) (*SayHelloResponse, error) {
...
func _HelloService_SayBye_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloService_SayBye_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).SayBye(ctx, req.(*SayHelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
