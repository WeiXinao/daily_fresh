...
const (
	...
	ginxPkg = protogen.GoImportPath("github.com/WeiXinao/daily_fresh/app/pkg/translator/ginx")
	codePkg = protogen.GoImportPath("github.com/WeiXinao/daily_fresh/pkg/gmicro/code")
	errPkg  = protogen.GoImportPath("github.com/WeiXinao/daily_fresh/pkg/errors")
	corePkg = protogen.GoImportPath("github.com/WeiXinao/daily_fresh/pkg/common/core")
	utPkg   = protogen.GoImportPath("github.com/go-playground/universal-translator")
	logPkg  = protogen.GoImportPath("github.com/WeiXinao/daily_fresh/pkg/log")
)
...
func GenerateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	// 设置生成的文件名，文件名会被 protoc 使用，生成的文件会被放在相应的目录下
	filename := file.GeneratedFilenamePrefix + "_gin.pb.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)

	// 该注释会被 go 的 ide 识别到，表示该文件是自动生成的，经量不要修改
	...
	g.QualifiedGoIdent(ginxPkg.Ident(""))
	g.QualifiedGoIdent(errPkg.Ident(""))
	g.QualifiedGoIdent(codePkg.Ident(""))
	g.QualifiedGoIdent(corePkg.Ident(""))
	g.QualifiedGoIdent(utPkg.Ident(""))
