...
func main() {
	fileName := "/root/repos/github.com/WeiXinao/daily_your_go/app/pkg/code/base.go"
	...
	src := []byte(buf.String())
	err = os.WriteFile("/root/repos/github.com/WeiXinao/daily_your_go/app/pkg/code/code_generated.go", src, os.ModePerm)
	if err != nil {
		panic(err)
	}
}
